...
const userRoute = require('./src/routes/logsRoute')
...
mongoose.connect('mongodb+srv://admin:admin@cluster1.cxdb4.mongodb.net/LogsCollection?retryWrites=true&w=majority&appName=Cluster1')
.then(() => {
  console.log("Connected to Logs Collection")
  app.listen(port, () => {
